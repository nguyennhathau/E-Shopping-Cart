...
<div id="body-content" style="width: 82%; margin:10px 9px">	
    ...
    <form action="/Webbanhangdientu/manager_CategoryServlet" method="post">
        ...
        <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="2"><div align="center">Cập nhập người dùng</div></td>
            </tr>
            <p style="background-color: blue;">${message}</p>  
            <tr>
                <td width="100">UserName:</td>
                <td width="250"><input name="username" type="text" value="<%=request.getParameter("username")%>"></td>
            </tr>

            <tr>
                <td width="100">PassWord:</td>
                <td width="250"><input name="password" type="text" value="<%=request.getParameter("password")%>"></td>
            </tr>
            <tr>
